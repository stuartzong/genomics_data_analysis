...
# mark6: genes hit by integration
mark6.file <- "/projects/trans_scratch/validations/workspace/szong/Cervical/integration/genes_hit_by_integration.txt" 
mark6s.df <- read.table(mark6.file, 
                        header=TRUE, 
                        sep="\t", 
                        quote="", 
                        as.is=TRUE, 
...
# hard code my.colors
# my.colors <- c("red", "blue", "purple", "green", "dark red" , "orange")
my.colors <- c("#e10020", "#0000ff", "#800080", "#008000", "#8b0000", "#c39797", "#6897bb", 
               "#ff00ff", "#00ffff", "#191919", "#ccff00", "#20b2aa", "#00ff00")
...
text(bp[16], 227349540, "DNA evidence: left half of bar")
text(bp[16], 217349540, "RNA evidence: right half of bar")
text(bp[16],207349540, "X: centromere" )
legend('topright', all.types, lty=1, col=my.colors, bty='n', cex=.75, lwd=8)
#legend('top', 'centromere', pch=4, col='black', bty='n', cex=.75)
